# @File Name: createPolar.py
# @File Path: K:\work\MAS2\Klampt_Robotic_Arm_Script\gridModelEncode\PolarCoordinates\polarModel\createPolar.py
# @Author: 29505
# @Date:   2019-02-08 09:18:50
# @Last Modified by:   29505
# @Last Modified time: 2019-02-08 14:52:53
...
for x in range (0,16):
	for rad in range(0,32):	
		with open('./trapezoid'+ str(x) +"_" +str(rad) +'.off','w') as modelFile:
			...
			X1_2 = radius * math.cos(theta+0.0825) 
			Y1_2 = radius * math.sin(theta+0.0825)


			X2_1 = (radius + 0.023) * math.cos(theta)
			Y2_1 = (radius + 0.023) * math.sin(theta)
			X2_2 = (radius + 0.023) * math.cos(theta+0.0825)
			Y2_2 = (radius + 0.023) * math.sin(theta+0.0825)
