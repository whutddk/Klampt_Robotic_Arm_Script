...
## 产生 X-11 Y-25 Z-13 个节点 （2880）
## X:100~350 Y:-300~300 Z:100~400
# 编号 X(0-10) Y(0-24) Z(0-12)
# 结点编号 Z*240 + Y*10 + X

# 产生11*25*12 + 11*24*13 + 10*25*13 = 9982条edge
# edge 编号 (0-9981)
# 建立二维数组从pose映射到edge
# X方向edge 0 + 11 * 24 * 13
# Y方向edge 3432 + 10 * 25 * 13
# Z方向edge 6682 + 11 * 25 * 12
