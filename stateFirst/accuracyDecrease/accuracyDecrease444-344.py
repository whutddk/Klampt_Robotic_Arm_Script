# -*- coding: utf-8 -*-
# @File Name: accuracyDecrease444-344.py
# @File Path: M:\MAS2\PRM_Robotic_Arm\Klampt_Robotic_Arm_Script\accuracyDecrease\accuracyDecrease444-344.py
# @Author: Ruige_Lee
# @Date:   2019-03-04 14:16:32
# @Last Modified by:   Ruige_Lee
# @Last Modified time: 2019-03-04 14:59:18
...
sourceFileLoc = './sp/4-4-4/250msx3/'
destFileLoc = './sp/3-4-4/250msx3/'
	...
	for edge in edgeSource:
		...
		for i in range (0,8):
			for j in range (0,256):
				if (edge[512*i+j] == 1  or edge[512*i+256+j] == 1 ):
