	...
	for i in xrange(1,32):
		for j in xrange (0,i):
			...
			for k in range (0,101):
				...
				cubeList = collisionTest.terrains

				collisionTest = WorldCollider(world)

				collisionTest.terrains = cubeList
				#print collisionTest.terrains
				...
				for p,q in collisionTest.robotTerrainCollisions(0):
					...
					y = int(result [9:12])
					z = int(result[13:16])
					create_truetable(edgeCnt,x,y,z)
					print 1024*x+32*y+z
					del(collisionTest.terrains[1024*x+32*y+z])
					#print q.getName()
					cnt = cnt + 1;
